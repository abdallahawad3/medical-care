...
export const pageStyles = {
  ...
  cancelButton: (isDisabled: boolean) =>
...
export const statusClasses = (status: string | undefined) => {
...
export const doctorListStyles = {
  ...
  availabilityBadge: (isAvailable: boolean) =>
  ...
  availabilityDot: (isAvailable: boolean) =>
...
export const serviceAppointmentsStyles = {
  ...
  rescheduleButton: (terminal: boolean) =>
...
export const serviceDashboardStyles = {
  ...
  refresh: {
    ...
    button: (hasServicesProp: boolean) =>
  ...
  table: {
    ...
    headerTextLg: (span: number) =>
      `col-span-${span} text-center text-xs font-medium`,
    ...
    desktopCell: (span: number) => `col-span-${span}`,
    desktopCenterCell: (span: number) => `col-span-${span} text-center`,
    ...
    mobileStatItem: (color: string = "emerald") =>
